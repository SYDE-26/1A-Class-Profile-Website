...
function Highschool() {
    return (
        <div>
            ...
            <Section header="Admission Averages + Extracurriculars" description="The admission average for the SYDE ‘26 cohort was 97%. The majority of us were not part of any enrichment program in high school but we did participate in a variety of extracurriculars." />
